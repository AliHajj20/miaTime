...
#' at 150 time points. Event==1 indicates Crohn's disease, and Event==0 indicates control.
#' The data is designed for compositional analysis of microbiome.
#' Name of dataset: @crohn_survival
